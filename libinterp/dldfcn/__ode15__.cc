...
// endif
  ...
  {
    octave_f77_int_type Neq = NV_LENGTH_C (yy);
...
#  endif
                    ...
                    const octave_idx_type num_event_args)
  {
    ...
    N_Vector dky = N_VNew_Octave (m_num OCTAVE_SUNCONTEXT);

    N_Vector dkyp = N_VNew_Octave (m_num OCTAVE_SUNCONTEXT);
