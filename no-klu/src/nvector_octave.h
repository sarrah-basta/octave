...
#define NV_CONTENT_S(v)  ( (N_VectorContent_Octave)(v->content) )
...
SUNDIALS_EXPORT N_Vector N_VNew_Octave(sunindextype vec_length);

SUNDIALS_EXPORT N_Vector N_VNewEmpty_Octave(sunindextype vec_length);

SUNDIALS_EXPORT N_Vector N_VMake_Octave(sunindextype vec_length, realtype *v_data);
...
SUNDIALS_EXPORT realtype *N_VGetArrayPointer_Octave(N_Vector v);
SUNDIALS_EXPORT void N_VSetArrayPointer_Octave(realtype *v_data, N_Vector v);

/* standard vector operations */
SUNDIALS_EXPORT void N_VLinearSum_Octave(realtype a, N_Vector x, realtype b, N_Vector y, N_Vector z);
SUNDIALS_EXPORT void N_VConst_Octave(realtype c, N_Vector z);
...
SUNDIALS_EXPORT void N_VScale_Octave(realtype c, N_Vector x, N_Vector z);
SUNDIALS_EXPORT void N_VAbs_Octave(N_Vector x, N_Vector z);
SUNDIALS_EXPORT void N_VInv_Octave(N_Vector x, N_Vector z);
SUNDIALS_EXPORT void N_VAddConst_Octave(N_Vector x, realtype b, N_Vector z);
SUNDIALS_EXPORT realtype N_VDotProd_Octave(N_Vector x, N_Vector y);
SUNDIALS_EXPORT realtype N_VMaxNorm_Octave(N_Vector x);
SUNDIALS_EXPORT realtype N_VWrmsNorm_Octave(N_Vector x, N_Vector w);
SUNDIALS_EXPORT realtype N_VWrmsNormMask_Octave(N_Vector x, N_Vector w, N_Vector id);
SUNDIALS_EXPORT realtype N_VMin_Octave(N_Vector x);
SUNDIALS_EXPORT realtype N_VWL2Norm_Octave(N_Vector x, N_Vector w);
SUNDIALS_EXPORT realtype N_VL1Norm_Octave(N_Vector x);
SUNDIALS_EXPORT void N_VCompare_Octave(realtype c, N_Vector x, N_Vector z);
...
SUNDIALS_EXPORT realtype N_VMinQuotient_Octave(N_Vector num, N_Vector denom);

/* fused vector operations */
SUNDIALS_EXPORT int N_VLinearCombination_Octave(int nvec, realtype* c, N_Vector* V,
                                                N_Vector z);
SUNDIALS_EXPORT int N_VScaleAddMulti_Octave(int nvec, realtype* a, N_Vector x,
...
SUNDIALS_EXPORT int N_VLinearSumVectorArray_Octave(int nvec, 
                                                   ...
                                                   N_Vector* Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_Octave(int nvec, realtype* c,
                                               N_Vector* X, N_Vector* Z);
SUNDIALS_EXPORT int N_VConstVectorArray_Octave(int nvecs, realtype c,
                                               N_Vector* Z);
...
SUNDIALS_EXPORT realtype N_VWSqrSumLocal_Octave(N_Vector x, N_Vector w);
SUNDIALS_EXPORT realtype N_VWSqrSumMaskLocal_Octave(N_Vector x, N_Vector w, N_Vector id);
